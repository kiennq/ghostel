...
fn addWindowsRuntimeLibraries(
    ...
    // The CI/release matrix currently uses MinGW targets, where Zig supplies
    // the import libraries. Keep the MSVC branch explicit for future MSVC
    // builds, which need vcruntime/ucrt libraries from the Windows SDK.
