...
Created under `default-directory' rather than depending on the system
temp directory's platform-specific layout.  The file and the directory
holding it are deleted afterwards."
  (declare (indent 1))
