...
(ert-deftest ghostel-test-download-module-refuses-live-buffers-before-reload ()
  "Downloading over a loader runtime refuses to reload with live terminals."
  (let ((system-type 'windows-nt)
        (module-file-suffix ".dll")
        (ghostel-module-dir "C:/ghostel/")
        (downloaded nil)
...
(defconst ghostel-test--elisp-tests
  '(ghostel-test-focus-window-selection
    ...
    ghostel-test-download-module-refuses-live-buffers-before-reload
