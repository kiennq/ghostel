...
test "backend hands handles to reaper once" {
    ...
    try std.testing.expect(process.output_read_event == c.INVALID_HANDLE_VALUE);
    ...
    try std.testing.expect(backend.output_read_event == fake_handle);
