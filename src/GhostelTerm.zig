...
pub const emacs_functions = [_]emacs.FunctionEntry{
    ...
    .{
        ...
        .impl = struct {
            pub fn call(env: emacs.Env, _: isize, args: [*c]emacs.Value) emacs.Value {
                ...
                return env.makeString(term.renderer.debugState(&buf));
            }
        },
    },
    .{
    ...
    .{
        ...
        .impl = struct {
            pub fn call(env: emacs.Env, _: isize, args: [*c]emacs.Value) emacs.Value {
                const term = env.getUserPtr(Self, args[0]) orelse return env.nil();
                const pos = term.renderer.cursorPosition() orelse return env.nil();
    ...
    .{
        ...
        .impl = struct {
            pub fn call(env: emacs.Env, _: isize, args: [*c]emacs.Value) emacs.Value {
                const term = env.getUserPtr(Self, args[0]) orelse return env.nil();
                const offset = term.renderer.cursorRowCharOffset() orelse return env.nil();
    ...
    .{
        ...
        .impl = struct {
            pub fn call(env: emacs.Env, _: isize, args: [*c]emacs.Value) emacs.Value {
                const term = env.getUserPtr(Self, args[0]) orelse return env.nil();
                const empty = term.renderer.cursorOnEmptyRow() orelse return env.nil();
    ...
    .{
        ...
        .impl = struct {
            pub fn call(env: emacs.Env, _: isize, args: [*c]emacs.Value) emacs.Value {
                const term = env.getUserPtr(Self, args[0]) orelse return env.nil();
                const line = term.renderer.redrawFullScrollback(env) catch |err| {
                    env.logStackTrace(@errorReturnTrace());
